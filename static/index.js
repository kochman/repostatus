		...
		<section class="jumbotron text-center">
			<div class="container">
				<div class="row justify-content-md-center centered">
					...
					<form class="form-inline text-center" v-on:submit.prevent="getStatus()">
						<div class="input-group">
							<input type="text" v-model="orgRepo" autocorrect="off" autocapitalize="off" spellcheck="false" class="form-control form-control-lg">
